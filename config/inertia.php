...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Use Script Element for Initial Page
    |--------------------------------------------------------------------------
    |
    | When enabled, the `@inertia` Blade directive outputs a
    | `<script id="app" type="application/json">` element containing the
    | initial page data instead of a `data-page` attribute on the root
    | element. This is slightly faster and easier to inspect in dev tools.
    |
    */
